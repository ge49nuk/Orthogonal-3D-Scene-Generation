...
def get_default_parser():
    ...
    group.add_argument('--trajectory_file', type=str, default='model/trajectories/examples/living_room_farmhouse.json')
    ...
    group.add_argument('--save_scene_every_nth', required=False, default=25, type=int)
    ...
    group.add_argument('--repaint', required=False, default=False, type=bool, help="Set to True to repaint the newly added geometry (and orthogonalizing it)")
    ...
    group.add_argument('--orth_mode', required=False, default="rot", help="Decides how the scene is orthogonalized (rot: only rotate vertices of new planes, proj: project vertices onto orthogonal planes, none: no orthogonalization)", 
                       choices=["rot","proj","none"])
    group.add_argument('--depth_details', required=False, default=False, type=bool, help="Set to True to integrate re-estimated depth (Only use with orth_mode:proj)")
